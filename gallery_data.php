        ...
        <div class="modal-content">
            ...
            <form method="post" action="admin.php?page=gallery" enctype="multipart/form-data">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="edit_gambar" class="btn btn-primary">Simpan</button>
                </div>
            </form>
        </div>
    </div>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <input type="hidden" name="id" value="<?= $row["id"] ?>">
                                                <div class="modal-body">
                                                    <div class="mb-3">
                                                        <label for="formGroupExampleInput" class="form-label">Yakin akan menghapus foto?</label>
                                                        <input type="hidden" name="id" value="<?= $row["id"] ?>">
